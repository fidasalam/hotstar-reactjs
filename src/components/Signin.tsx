...
const Signin = () => {
    ...
    const sendOtp = async() =>{
        try{
            const recaptchaId = 'recaptcha'; // Ensure this ID matches the ID of the recaptcha element
            const recaptcha = new RecaptchaVerifier(auth, recaptchaId, {}); // Pass auth.getAuth()
